          ...
          <Card className="bg-cream backdrop-paper border-rose-200 shadow-paper max-w-lg w-full">
            ...
            <CardContent className="space-y-6 text-center px-6 pb-8">
              <p className="text-2xl text-gray-700 font-serif leading-relaxed">
                Il dono più grande è la vostra presenza.<br />
                Se desiderate farci un pensiero vi chiediamo un contributo per realizzare i nostri sogni.<br />
                Il vostro regalo sarà in parte devoluto al sostegno della famiglia che vive nella striscia di Gaza
                (questo sarà possibile grazie a{" "}
                <a
                  href="https://www.instagram.com/martaalacevich"
                  target="_blank"
                ...
                ) e alla missione di Llamellin in Perù dell'Associazione Amici del Perù.
              </p>
              {!showIban ? (
